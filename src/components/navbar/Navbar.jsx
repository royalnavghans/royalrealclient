            ...
            <>
              ...
              {showModal && (
                <div className={classes.userModal}>
                  ...
                  <Link onClick={() => setShowForm(true)} className={classes.list}>Create your property</Link>
                  <Link onClick={() => setShowModal(prev => !prev)} className={classes.yachtBtn} to={`/yachts`}>See yachts!</Link>
                  <Link to={`/create-yacht`} onClick={() => setShowModal(prev => !prev)}>Create your yacht</Link>
                </div>
              )}
            </>
          }
